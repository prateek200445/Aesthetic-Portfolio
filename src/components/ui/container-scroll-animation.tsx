...
export const ContainerScroll = ({
  ...
  const scaleDimensions = () => (isMobile ? [0.72, 0.92] : [1.08, 1]);
...
export const Card = ({
  ...
  <motion.div
    ...
    className="mx-auto w-full max-w-[1200px] border border-white/15 bg-[#0b0f13] rounded-[20px] shadow-2xl overflow-hidden"
  >
    <div className="h-full w-full overflow-hidden rounded-[18px] bg-[#0b0f13]">
      {children}
    </div>
  </motion.div>
);
