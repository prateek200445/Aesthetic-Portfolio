...
const createParticles = (
  ...
  if ("fontKerning" in ctx) (ctx as never as { fontKerning: string }).fontKerning = "normal";
  if ("textRendering" in ctx) (ctx as never as { textRendering: string }).textRendering = "geometricPrecision";
