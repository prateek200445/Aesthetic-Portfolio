...
export default function RotatingEarth({
  ...
  useEffect(() => {
    ...
    const pointInFeature = (point: [number, number], feature: GeoFeature): boolean => {
      ...
      if (geometry.type === "MultiPolygon") {
        const multiCoordinates = geometry.coordinates as number[][][][];
        for (const polygon of multiCoordinates) {
  ...
  return (
    <div className={`relative ${className}`} style={{ width: "1100px", height: "620px" }}>
      <canvas
        ref={canvasRef}
